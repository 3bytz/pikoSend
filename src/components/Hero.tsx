...
export const Hero: React.FC = () => {
  ...
  return (
    <>
      ...
      />
      <section
        className="relative min-h-screen overflow-hidden pt-20 md:pt-32 pb-12 md:pb-20"
        style={{
          background:
            "radial-gradient(circle at top right, #9A6AFD 0%, #582C8D 40%, #3E1C6D 100%)",
        }}
      >
        ...
        <Container className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center min-h-[calc(100vh-80px)]">
          <div className="lg:col-span-6 animate-fade-up space-y-6">
            <div>
              ...
              <p className="text-white text-lg mt-6 leading-relaxed max-w-md opacity-90">
                Experience seamless transactions and enhanced security -
                empowering your personal and business growth.
              </p>
            </div>
          ...
          <div
            className="lg:col-span-6 flex justify-center animate-slide-up"
