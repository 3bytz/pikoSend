        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
          <div>
            ...
            <p className="text-lg md:text-xl text-piko-medium-grey mb-8 leading-relaxed">
              Thousands of satisfied customers across Africa trust PikoSend for their daily transactions, 
              business payments, and personal transfers.
            </p>
            ...
            <div className="relative overflow-hidden rounded-2xl shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  <div className="grid grid-cols-3 gap-6">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-sm text-white/80">Average Transfer Time</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute top-6 right-6 px-4 py-2 bg-white rounded-full shadow-lg">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-piko-purple">Trusted Choice</span>
                </div>
              </div>
            </div>
